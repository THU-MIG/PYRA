...
# custom optimizer for lr group
from model.optim_factory import create_optimizer
...
from model.vision_transformer_timm import VisionTransformer
...
def main(args):
    ...
    if args.token_merging:
        tome_r = get_merging_schedule(cfg.MODEL_NAME, args.merging_schedule)
        pyra_r = None
        if args.pyra:
            pyra_r = tome_r
    else:
    ...
    model = models.__dict__[cfg.MODEL_NAME](   
                                                ...
                                                prompt_tuning_dim=cfg.VISUAL_PROMPT_DIM,LoRA_dim=cfg.LORA_DIM,adapter_dim=cfg.ADAPTER_DIM,prefix_dim=cfg.PREFIX_DIM,
